...
def keywordFacts : List KeywordFacts :=
  [
    ...
    { word := "Convoke", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true },
    { word := "Improvise", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true },
    { word := "Storm", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, bodied := true },
    ...
    { word := "Multikicker", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true },
    ...
    { word := "Flashback", paramShapes := [.cost], onPermanentCard := false, onInstantOrSorceryCard := true, paidCost := true },
    ...
    { word := "Warp", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true },
    ...
    { word := "Affinity", paramShapes := [.quality], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true },
    ...
    { word := "Prowl", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true },
    { word := "Surge", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true },
    { word := "Spectacle", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true },
    { word := "Freerunning", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true },
    { word := "Sneak", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true },
    ...
    { word := "Entwine", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true, wantsModes := true },
    { word := "Escalate", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true, wantsModes := true },
    { word := "Fuse", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onPermanentCard := false, onInstantOrSorceryCard := true },
    ...
    { word := "Overload", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onPermanentCard := false, onInstantOrSorceryCard := true, paidCost := true },
    ...
    { word := "Cleave", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onPermanentCard := false, onInstantOrSorceryCard := true, paidCost := true },
    { word := "Harmonize", paramShapes := [.cost], onPermanentCard := false, onInstantOrSorceryCard := true, paidCost := true },
    { word := "Impending", paramShapes := [.compound .number], regime := some .atCasting, functionsOnStack := true, paidCost := true },
    { word := "Awaken", paramShapes := [.compound .number], regime := some .atCasting, functionsOnStack := true, onPermanentCard := false, onInstantOrSorceryCard := true, paidCost := true },
    { word := "Buyback", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onPermanentCard := false, onInstantOrSorceryCard := true, paidCost := true },
    { word := "Casualty", paramShapes := [.number], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true },
    ...
    { word := "Gift", paramShapes := [.subject], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true },
    { word := "Replicate", paramShapes := [.cost], regime := some .atCasting, functionsOnStack := true, onPermanentCard := false, onInstantOrSorceryCard := true, paidCost := true },
    { word := "Delve", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true },
    { word := "Infect", paramShapes := [.noParam], regime := some .atResolution },
    { word := "Cascade", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, bodied := true },
    { word := "Prowess", paramShapes := [.noParam], regime := some .atCasting, bodied := true },
    { word := "SplitSecond", paramShapes := [.noParam], functionsOnStack := true, onPermanentCard := false, onInstantOrSorceryCard := true },
    ...
    { word := "Aftermath", paramShapes := [.noParam], onPermanentCard := false, onInstantOrSorceryCard := true },
    { word := "Amplify", paramShapes := [.number] },
    { word := "Assist", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true },
    { word := "AuraSwap", paramShapes := [.cost], paidCost := true },
    { word := "Backup", paramShapes := [.number], bodied := true },
    { word := "Bargain", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true },
    { word := "BattleCry", paramShapes := [.noParam], bodied := true },
    { word := "Bloodthirst", paramShapes := [.number] },
    { word := "Champion", paramShapes := [.subject] },
    { word := "Cipher", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onPermanentCard := false, onInstantOrSorceryCard := true },
    { word := "Compleated", paramShapes := [.noParam] },
    { word := "Conspire", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, paidCost := true },
    { word := "Daybound", paramShapes := [.noParam] },
    { word := "Demonstrate", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, bodied := true },
    ...
    { word := "Gravestorm", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, bodied := true },
    ...
    { word := "JumpStart", paramShapes := [.noParam], onPermanentCard := false, onInstantOrSorceryCard := true },
    ...
    { word := "Rebound", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onPermanentCard := false, onInstantOrSorceryCard := true },
    ...
    { word := "Ripple", paramShapes := [.number], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, bodied := true },
    ...
    { word := "Spree", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, wantsModes := true },
    { word := "StartYourEngines", paramShapes := [.noParam] },
    { word := "Station", paramShapes := [.noParam] },
    { word := "Sunburst", paramShapes := [.noParam] },
    { word := "Teamwork", paramShapes := [.number], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true },
    { word := "Tiered", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true, wantsModes := true },
    ...
    { word := "Undaunted", paramShapes := [.noParam], regime := some .atCasting, functionsOnStack := true, onInstantOrSorceryCard := true },
