...
fn authentic_nominal_and_selector_sentences_parse() {
    ...
    for witness in [
        ...
        Witness {
            ...
            path: "",
            specificity: "NNNNTNNNNNNNNTNNT",
            candidates: 1,
        },
        Witness {
        ...
        Witness {
            ...
            path: "",
            specificity: "NNNNTNNNNNNNNLLLNNNTT",
            candidates: 2,
        },
        Witness {
