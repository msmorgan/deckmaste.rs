...
mod tests {
    ...
    const EXPECTED_GENERATED_CONSTRUCTION_NAMES: &[&str] = &[
        ...
        "ActivationCostComponentCostClause",
        "AbilityActivated",
        "SentenceImperative",
        "SentenceDeclarative",
        "SentenceAttached",
        ...
        "SentenceWithWhere",
        "PredicateCoordinationAndPredicateCoordination",
        "PredicateCoordinationOrPredicateCoordination",
        "PredicateCoordinationAndOrPredicateCoordination",
        "PredicativeAdjectiveComplementPredicativeAdjective",
        "PredicativeColorComplementPredicativeColor",
        "PredicativeTypeComplementPredicativeType",
        ...
        "PredicativePowerToughnessComplementPredicativePowerToughness",
        ...
        "ClauseCoordinationAndClauseCoordination",
        "ClauseCoordinationOrClauseCoordination",
        "ClauseCoordinationAndOrClauseCoordination",
        ...
        "OnDestinationOnLibraryDestination",
        ...
        "CounterKindPositivePowerToughnessCounter",
        "CounterKindNegativePowerToughnessCounter",
    ...
    #[test]
    fn selection_diagnostic_uses_every_generated_construction_name() {
        let names = generated_constructions_v1()
            .into_iter()
            .map(Construction::name)
            .collect::<Vec<_>>();

        assert_eq!(names, EXPECTED_GENERATED_CONSTRUCTION_NAMES);
    }
