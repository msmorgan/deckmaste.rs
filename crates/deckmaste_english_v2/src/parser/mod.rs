        ...
        assert_eq!(
            ...
            std::collections::BTreeSet::from([
                ...
                (
                    14,
                    21,
                    "Noun { noun: Declaration(DeclarationNoun { id: DeclarationIdentity { kind: Subtype(Creature), name: \"Spirit\" }, locative_temporal_license: Unlicensed, relationality: NonRelational }), number: Singular, onset: Consonant, possessive_ending: Other }",
                ),
            ])
        );
