// Detects the generated, CR-derived catalogs (`data/gen/catalogs`) at build
// time and, when present, sets the `gen_catalogs` cfg. The unify/render
