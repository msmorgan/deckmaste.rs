...
//! [`TemplateIndex`](deckmaste_legacy_render::template::index::TemplateIndex).
//! It claims whole-line keyword templates — nullary (`flying` →
//! `Keyword(Flying)`) and parameterized (`protection from black` →
