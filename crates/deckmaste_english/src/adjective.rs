//! Checked construction, projection, and rendering API for adjectives.
//!
...
//! matching `parts_*` functions and accessors provide immutable projections.
...
pub use crate::constructions::adjective::parts_adjective;
pub use crate::constructions::adjective::parts_adjective_phrase;
pub use crate::constructions::adjective::parts_adjective_phrase_comparison;
pub use crate::constructions::adjective::parts_adjective_phrase_degree_measure;
pub use crate::constructions::adjective::parts_adjective_phrase_face_down;
pub use crate::constructions::adjective::parts_adjective_phrase_face_up;
pub use crate::constructions::adjective::parts_comparison_standard;
pub use crate::constructions::adjective::parts_comparison_than;
pub use crate::constructions::adjective::parts_comparison_than_or_equal_to;
