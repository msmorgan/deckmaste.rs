...
///
/// Kinds are keyed by serde name, not type path, so these are the same kinds
/// `deckmaste_core` mints — which is why existing macro definitions parse
/// against this grammar unchanged.
#[must_use]
