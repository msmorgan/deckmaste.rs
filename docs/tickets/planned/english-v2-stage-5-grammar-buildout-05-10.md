...
---
Continue the English v2 Stage 5 grammar buildout from the integrated Plan 04
generated-invariant substrate through Plans 05–10. Authority remains
`docs/decisions/english-v2-rewrite.md`; preserve the generated declaration
authority, open declaration families, and immutable parser-environment
authority established by Plans 03–04.
...
The locked Plan 04 corpus baseline is 32,285 normalized units: 48 are selected,
covered, byte-exact, and totally owned, while 32,237 are ordinary parse
failures. The Plan 04 elapsed-time ceiling is 16.26 seconds for each of the
seven established corpus-scale gates. Those figures are the starting point,
not Stage 5 completion evidence.
