...
values with three color-property adjectives. Rename the vocabulary and all
five declaration consumers plus the `ast.rs` use so the Oracle-English name
does not claim that every member is a Game Model Color.
