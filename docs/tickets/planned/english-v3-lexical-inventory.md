---
needs: [english-v3-lexical-model, english-v2-keyword-action-verb-inflections]
---
...
irregular overrides. Import useful declarations from the keyword-action
inflection work after its owner lands; do not duplicate or edit that WIP. Map
